...
PACKAGE_STRING = photoprint 0.4.1-pre4
PACKAGE_TARNAME = photoprint
PACKAGE_VERSION = 0.4.1-pre4
PATH_SEPARATOR = :
...
carouselcheck$(EXEEXT): $(carouselcheck_OBJECTS) $(carouselcheck_DEPENDENCIES) 
	@rm -f carouselcheck$(EXEEXT)
	$(CXXLINK) $(carouselcheck_OBJECTS) $(carouselcheck_LDADD) $(LIBS)
